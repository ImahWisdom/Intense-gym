    ...
    <>
      <div className="contact-page" data-aos="fade-in">
        ...
        <div className="contact-info" data-aos="fade-up" data-aos-delay="200">
          ...
          <p>
            <strong>Address:</strong> 2 Akowonjo Rd, Shasha Rd, opposite Dopemu Under Bridge,
            Alimosho, Ikeja 102213, Lagos
          </p>
        </div>
        ...
        {/* ===== Google Map Section ===== */}
        <div className="map" data-aos="fade-up" data-aos-delay="400">
          <h2>Our Location</h2>
          <iframe
            title="Google Map"
